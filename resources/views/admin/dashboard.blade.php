...
<div class="container-fluid py-4">
    <!-- Introductory banner -->
    <div class="row">
        <div class="col-11 mb-xl-0 mx-auto my-5 border w-full rounded text-center d-flex justify-content-center align-items-center" style="height:200px; height: 200px; background: url('{{ asset('assets/img/pxfuel.jpg') }}') no-repeat center center; background-size: cover;">
