...
<div class="container-fluid py-4">
    ...
    <div class="row">
        ...
        <div class="col-8 mb-xl-0 mx-auto my-5 border w-full rounded text-center d-flex justify-content-center align-items-center" style="height:150px;background-color:black">
