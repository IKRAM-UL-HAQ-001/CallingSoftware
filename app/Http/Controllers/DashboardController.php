...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $dailyData = [
            ['label' => "Customers Today", 'value' => $TotalCustomerDaily, 'icon' => "ni ni-single-02"],
            ['label' => "Demos Sent Today", 'value' => $TotalDemoSendDaily, 'icon' => "ni ni-email-83"],
            ['label' => "Follow Ups Today", 'value' => $TotalFollowUpDaily, 'icon' => "ni ni-chat-round"],
            ['label' => "Referred IDs Today", 'value' => $TotalReferIdDaily, 'icon' => "ni ni-badge"],
            ['label' => "Rejections Today", 'value' => $TotalRejectDaily, 'icon' => "ni ni-fat-remove"],
            ['label' => "Total Calls Today", 'value' => $TotalCallsDaily, 'icon' => "ni ni-mobile-button"],
            ['label' => "Walk-ins Today", 'value' => $TotalWalkDaily, 'icon' => "ni ni-user-run"]
        ];

        $monthlyData = [
            ['label' => "Customers This Month", 'value' => $TotalCustomerMonthly, 'icon' => "ni ni-calendar-grid-58"],
            ['label' => "Demos Sent This Month", 'value' => $TotalDemoSendMonthly, 'icon' => "ni ni-bell-55"],
            ['label' => "Follow Ups This Month", 'value' => $TotalFollowUpMonthly, 'icon' => "ni ni-time-alarm"],
            ['label' => "Referred IDs This Month", 'value' => $TotalReferIdMonthly, 'icon' => "ni ni-collection"],
            ['label' => "Rejections This Month", 'value' => $TotalRejectMonthly, 'icon' => "ni ni-folder-remove"],
            ['label' => "Total Calls This Month", 'value' => $TotalCallsMonthly, 'icon' => "ni ni-support-16"],
            ['label' => "Walk-ins This Month", 'value' => $TotalWalkMonthly, 'icon' => "ni ni-chart-bar-32"]
        ];
